...
$languageArray= [ "dripfeeds.title" => "Drip-feed", 
 ...
 "smmspot.terms.tab1.text" => "<h3>Substances</h3> <p>At SMM1ST, we provide services solely for the purpose of social media promotion. Our platform offers automated processes that make your life easier, but we strongly discourage any spamming or violation of the law.</p>  <p>As a user, you must comply with the terms and conditions of any social network you use, as well as any applicable legislation. Please note that using our services is entirely at your own risk.</p>  <p>We do not take responsibility for any accounts that are banned for any reason, nor do we provide refunds. Moreover, we strictly prohibit the exploitation of our system, including gaining credits, exploiting speed, or any other bugs, except through regular features or purchasing them from our website.</p>  <p>At SMM1ST, we value the privacy and security of our users. However, we cannot guarantee 100% protection against social media platforms' detection algorithms. Therefore, we advise you to use our services at your own discretion.</p>  <p>Thank you for choosing SOCIALMMPANEL. If you have any questions or concerns, please do not hesitate to contact us.</p>  <h3>Services</h3> <p>1. SMM sole purpose is for social media promotion.<br> 2. You shall not knowingly exploit the system including but not limited to, gaining credits, exploit speed or any other bug in a manner other than purchasing them from the website or use the regular features.<br>							3. We are not to blame if your accounts are banned for any reason.<br>							4. SMM1ST is brought to you to make your life easier with automated processes. We discourage spam and violation of the law.<br>							5. It is your sole responsibility to comply with any social network you use and any legislation that you are subject to. You use SMM at your own risk.</p>", 
 "smmspot.terms.tab2.text" => "<p>At SOCIALMMPANEL, we understand the importance of keeping your personal information secure. We take every possible measure to ensure that your data is protected from unauthorized access or disclosure.</p>  <p>Our website is protected by SSL encryption, which means that all data transferred between your browser and our server is encrypted and cannot be intercepted by third parties. In addition, we use secure payment gateways to ensure that your financial information is never compromised.</p>  <p>We also have strict measures in place to prevent any unauthorized access to our system. We monitor our servers and applications constantly to ensure that they are up to date with the latest security patches and software updates.</p>  <p>However, please note that no system can be entirely secure, and we cannot guarantee that our services will be completely immune to attacks or hacks. Therefore, we advise our users to take their own precautions, such as using strong passwords and regularly updating them, avoiding clicking on suspicious links or downloading files from untrusted sources, and being vigilant about any unauthorized access or unusual activity in their accounts.</p>  <p>In case you suspect any security breaches or unusual activity in your account, please contact us immediately so that we can take appropriate action to protect your account and investigate the issue.<br/>  <p>Thank you for choosing SOCIALMMPANEL. If you have any further questions or concerns about our security measures, please do not hesitate to contact us.</p>", 
 "smmspot.terms.tab3.text" => "<ol><li><p>Eligibility: To use our services, you must be at least 18 years old or the legal age of majority in your country of residence. By using our services, you represent and warrant that you are eligible to use them.</p></li><li><p>Prohibited Activities: You agree not to use our services for any illegal or unauthorized purpose, including but not limited to spamming, hacking, phishing, or any other activity that violates any applicable law or regulation. You also agree not to use our services to impersonate any person or entity, or to misrepresent your affiliation with any person or entity.</p></li><li><p>Account Security: You are solely responsible for maintaining the confidentiality of your account information, including your username and password. You agree to notify us immediately if you suspect any unauthorized access or use of your account. We will not be responsible for any loss or damage arising from your failure to comply with this obligation.</p></li><li><p>Payment: Our services are offered on a pre-paid basis, and you agree to pay for them in advance. We reserve the right to change our pricing and payment policies at any time, and we will notify you of any changes in advance. We do not offer refunds for any unused credits or services.</p></li><li><p>Intellectual Property: Our website and services contain proprietary and confidential information that is protected by copyright, trademark, and other intellectual property laws. You agree not to copy, modify, distribute, or create derivative works based on our services or website without our prior written consent.</p></li><li><p>Disclaimer of Warranties: We provide our services on an 'as is' and 'as available' basis, without any warranties of any kind, whether express or implied, including but not limited to warranties of merchantability, fitness for a particular purpose, or non-infringement. We do not warrant that our services will meet your requirements, be uninterrupted, or be error-free.</p></li><li><p>Limitation of Liability: In no event shall SMM1ST or its affiliates, partners, or agents be liable for any indirect, incidental, special, or consequential damages arising out of or in connection with your use of our services or website, including but not limited to damages for loss of profits, goodwill, use, or data. Our total liability to you shall not exceed the amount paid by you to us for the services.</p></li><li><p>Indemnification: You agree to indemnify, defend, and hold harmless SMM1ST and its affiliates, partners, and agents from any and all claims, damages, losses, liabilities, costs, and expenses (including reasonable attorneys' fees) arising out of or in connection with your use of our services or website, or any breach of this agreement.</p></li><li><p>Termination: We may terminate this agreement and your access to our services at any time, with or without cause, by giving you notice. Upon termination, you must cease all use of our services and website.</p></li><li><p>Governing Law: This agreement shall be governed by and construed in accordance with the laws of [your country/state], without giving effect to any principles of conflicts of law.</p></li></ol>", 
 ...
 "links" => "Links", 
 "terms_conditions" => "Terms and Condiction", 
 "rule_1" => "If your transaction on any platform is deleted or removed after confirmation, you will be removed from wixout.com indefinitely without refunding your balance.", 
 "rule_2" => "If you create any notification before completing the post-share approval period, your post will not be approved.", 
 "rule_3" => "In posts that are published on social media platforms, you must report screenshots of post statistics in detail.", 
 "rule_4" => "Posts published on social media platforms are priced per 1000 organic views. Virtualization should not be used. As you know, this is our job, if we detect any abuse, we will not approve your post.", 
 "rule_5" => "In the posts you share on Youtube, at least 100 people must visit our site for every 1000 views using your referral link, and at least 10 people must upload credit through your referral link. Otherwise, we will not agree on any of your submissions.", 
 "rule_desc" => "There is no sharing limit. You can share what you see.", 
 "close" => "Close", 
