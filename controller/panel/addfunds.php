...
$paymentsList = $conn->prepare("SELECT * FROM payment_methods WHERE method_type=:type && id!=:id &&id!=:id2 ORDER BY method_line ASC ");
$paymentsList-> execute(array("type"=>2,"id"=>7,"id2" => 14 ));
